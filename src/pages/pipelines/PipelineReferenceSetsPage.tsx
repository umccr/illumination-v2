...
async function getPipelineData(pipelineId: string): Promise<ReferenceSetList> {
  // Generate axios parameter
  const PipelineParamCreator = PipelineApiAxiosParamCreator();
  const getPipelinesParam = await PipelineParamCreator.getPipelineReferenceSets(
    pipelineId
  );
...
function PipelinePage() {
  ...
  return (
    ...
    >
      <Grid item xs={12}>
        <Typography variant="h4">Pipeline Reference Sets</Typography>
      </Grid>
      <Grid item xs={12}>
